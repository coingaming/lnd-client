...
, network-bitcoin, persistent, proto3-suite, proto3-wire
, qrcode-core, qrcode-juicypixels, stdenv, text, unbounded-delays
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    grpc-haskell-core hspec JuicyPixels katip network-bitcoin
    persistent proto3-suite proto3-wire qrcode-core qrcode-juicypixels
    text unbounded-delays universum unliftio vector
  ];
