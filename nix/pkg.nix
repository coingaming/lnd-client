...
, JuicyPixels, katip, lens, monad-logger, monad-time, mtl
, persistent, qrcode-core, qrcode-juicypixels, QuickCheck
, quickcheck-instances, resource-pool, retry, scientific, scotty
, stdenv, text, time, tls, transformers, unbounded-delays, unliftio
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson aeson-casing aeson-qq async base base64-bytestring bytestring
    ...
    http-client http-client-tls http-conduit http-types jose
    JuicyPixels katip lens monad-logger monad-time mtl persistent
    qrcode-core qrcode-juicypixels QuickCheck quickcheck-instances
    resource-pool retry scientific scotty text time tls transformers
