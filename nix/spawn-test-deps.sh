...
nohup lnd --bitcoin.active --bitcoin.regtest --lnddir=$LND_MERCHANT_DIR > $THIS_DIR/.lnd-merchant/stdout.log &
...
nohup lnd --bitcoin.active --bitcoin.regtest --lnddir=$LND_CUSTOMER_DIR > $THIS_DIR/.lnd-customer/stdout.log &
