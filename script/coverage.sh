...
--exclude=Proto.InvoiceGrpc \
--exclude=Proto.InvoiceGrpc_Fields \
--exclude=Proto.LndGrpc \
--exclude=Proto.LndGrpc_Fields \
--exclude=Proto.RouterGrpc \
--exclude=Proto.RouterGrpc_Fields \
--exclude=Proto.WalletUnlockerGrpc \
--exclude=Proto.WalletUnlockerGrpc_Fields \
--exclude=Proto.SignerGrpc \
--exclude=Proto.SignerGrpc_Fields \
