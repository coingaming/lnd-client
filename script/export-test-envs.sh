...
alias lncli-merchant="lncli -n regtest --lnddir=$LND_MERCHANT_DIR --rpcserver=127.0.0.1:10109"
export LND_CUSTOMER_DIR="$THIS_DIR/.lnd-customer"
alias lncli-customer="lncli -n regtest --lnddir=$LND_CUSTOMER_DIR --rpcserver=127.0.0.1:11109"
